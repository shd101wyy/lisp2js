...
h||"-"===h||"*"===h||"/"===h||"%"===h||"=="===h||"<"===h||">"===h||"!="===h||"<="===h||">="===h||"&&"===h||"||"===h||"&"===h||"|"===h){e="(";f=a.rest;if(null==f.rest)return"+"===h||"*"===h||"%"===h?(c?"return ":"")+b(f.first,null,null,null,!0):"-"===h?(c?"return ":"")+"(-"+b(f.first,null,null,null,!0)+")":"/"===h?(c?"return ":"")+"(1/"+b(f.first,null,null,null,!0)+")":(c?"return ":"")+"true";for(;null!=f;)p=b(f.first,null,null,null,!0),e+=p,null!=f.rest&&(e+=" "+("=="===h?"===":h)+" "),f=f.rest;return(c?
"return ":"")+e+")"}if("instanceof"===h)return(c?"return ":"")+"("+b(a.rest.first)+" instanceof "+b(a.rest.rest.first)+")";if("get"===h){e=f=b(a.rest.first);for(k=a.rest.rest;null!=k;)m=b(k.first),'"'===m[0]?(l=m.slice(1,-1),e=l===A(l)&&isNaN(l)?e+("."+l):e+("["+m+"]")):e+="["+m+"]",k=k.rest;return(c?"return ":"")+e}if("try"===h)return g=a.rest,a=g.first,e="try{"+b(a,!0,l,c||f,null,k),e+="}",g=g.rest,null!=g&&"catch"===g.first&&(e+="catch(",m=b(g.rest.first),e+=m+"){",a=g.rest.rest.first,e+=b(a,!0,
l,c||f,null,k),e+="}",g=g.rest.rest.rest),null!=g&&"finally"===g.first&&(a=g.rest.first,e+="finally {",e+=b(a,!0,l,c||f,null,k),e+="}"),e;if("throw"===h||"yield"===h)return h+" "+b(a.rest.first,null,null,null,!0)+(c?"; return;":"");if("in"===h)return(c?"return ":"")+"("+b(a.rest.first)+" in "+b(a.rest.rest.first)+")";if("defmacro"===h){e=b(a.rest.first);if("string"!=typeof e)return console.log("ERROR: Invalid macro name: "+e.toString()),"";g=a.rest.rest;d[e]=g;return""}k=a.first;f=a.rest;k=b(k);"recur"===
k&&g&&(!1===l[0]&&(l[0]="__lisp__recur__$"+s,s+=3),k=l[0],a.first=k);e=k;"}"!==k[k.length-1]&&isNaN(k)||(e="("+e+")");if(k in d)return e=C(d[k],f),(c?"return ":"")+b(e);e+=B(f);return(c?"return ":"")+e}return isNaN(a)&&"'"!==a[0]&&'"'!==a[0]&&":"!==a[0]?(c?"return ":"")+A(a):(c?"return ":"")+a};r=function(a,d,l,c){for(var f="",k,h=!1;null!=a;){d&&null==a.rest&&(h=!0);k=b(a.first,null===a.rest?!0:!1,c,h);"string"===typeof k&&(k=k.trim());"string"===typeof k&&0!==k.length&&";"!==k[k.length-1]&&(k+=
"; ");if(l)if(node_environment)try{n=vm.runInContext(k,y,"lisp.vm")}catch(m){console.log(m)}else try{window.eval(k)}catch(e){console.log(e)}f+=k;a=a.rest}return f};return{lexer:m,parser:q,compiler:b,lisp_compiler:r,compile:function(a){a=m(a);if(null===a)return null;a=q(a);return r(a,!1,!0)},getEvalResult:function(){return n}}},lisp=lisp_module();"undefined"!==typeof module&&(module.exports.compile=lisp.compile,module.exports.getEvalResult=lisp.getEvalResult);
