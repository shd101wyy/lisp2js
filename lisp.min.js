...
f,l)));c=n+";"+c;return d?c+"; return "+f+";":e?"(function(){"+c+" return "+f+";}())":c}if("defmacro"===h){c=b(a.rest.first);if("string"!=typeof c)return console.log("ERROR: Invalid macro name: "+c.toString()),"";k=a.rest.rest;g[c]=k;return""}l=a.first;e=a.rest;l=b(l,null,null,null,!0);if("recur"===l&&m)!1===f[0]&&(f[0]="__lisp__recur__$"+t,t+=3),l=f[0],a.first=l;else{if("super"===l)return e=y(e),c="this.__proto__.__proto__.constructor.call(this"+("()"===e?")":", "+e.slice(1)),(d?"return ":"")+c;
if("string"===typeof l&&"super."===l.slice(0,6)||"super["===l.slice(0,6))return e=y(e),c="this.__proto__.__proto__"+l.slice(5)+".call(this"+("()"===e?")":", "+e.slice(1)),(d?"return ":"")+c}c=l;"}"!==l[l.length-1]&&isNaN(l)||(c="("+c+")");if(l in g)return c=F(g[l],e),(d?"return ":"")+b(c);c+=y(e);return(d?"return ":"")+c}return isNaN(a)&&"'"!==a[0]&&'"'!==a[0]&&":"!==a[0]?(d?"return ":"")+C(a):(d?"return ":"")+a};s=function(a,g,f,d,e){for(var l="",h,c=!1;null!==a;){g&&null===a.rest&&(c=!0);h=b(a.first,
null===a.rest?!0:!1,d,c);"string"===typeof h&&(h=h.trim());"string"===typeof h&&0!==h.length&&";"!==h[h.length-1]&&(h+=";");if(f)if(node_environment)try{m=vm.runInContext(h,A,"lisp.vm"),e&&console.log(m)}catch(n){console.log(n)}else try{m=window.eval(h),e&&console.log(m)}catch(p){console.log(p)}l+=h;a=a.rest}return l};return{lexer:p,parser:r,compiler:b,lisp_compiler:s,compile:function(a,b){var f=p(a);if(null===f)return null;f=r(f);return s(f,!1,!0,null,b)},getEvalResult:function(){return m}}},lisp=
lisp_module();"undefined"!==typeof module&&(module.exports.compile=lisp.compile,module.exports.getEvalResult=lisp.getEvalResult);
